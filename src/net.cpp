...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Fredcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"fredcointools.com", "dnsseed.fredcointools.com"},
    {"fredcoinpool.org", "dnsseed.fredcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"fredcointools.com", "testnet-seed.fredcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Fredcoin is probably already running."), addrBind.ToString().c_str());
        else
